...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#createBtn").click(function(){
			...
			//点击创建时发送ajax请求得到所用者
			$.ajax({
				url:"workbench/clue/getOwner.do",
				type:"get",
				dataType:"json",
		...
		$.ajax({
			...
			success:function(data){
				...
				$.each(data,function(i,n) {
					...
					html +='<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href=\'workbench/clue/detail.do?clueId='+n.id+'\';">'+n.fullname+'</a></td>'
